...
def classify_image(image_path: str, comment: str) -> str:
    content = f"""
                ...
                "Department responsible": ['Medical Assistance', 'Security', 'Divyangjan Facility', 'Facilities for Women with Special needs', 'Unreserved Ticketing', 'Luggage/Parcels', 'Refunds of Tickets', 'Passenger Amenities', 'Electrical Equipment', 'Staff Behaviour', 'Cleanliness', 'Catering & Vending Services', 'Water Availability', 'Goods', 'Corruption/Bribery', 'Miscellaneous'],
